...
with app.app_context():
    ...
    # user1 = User(name='Stephen Bowen', email='stephen@gmail.com', _password_hash='12345')
    # user2 = User(name='Marion Aluoch', email='marion@gmail.com', _password_hash='12345')
    # user3 = User(name='Dennis Kinyanjui', email='dennis@gmail.com', _password_hash='12345')
